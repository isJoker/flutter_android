...
projectTabEntityFromJson(ProjectTabEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<ProjectTabData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new ProjectTabData().fromJson(v));
		});
	}
...
projectTabDataFromJson(ProjectTabData data, Map<String, dynamic> json) {
...
Map<String, dynamic> projectTabDataToJson(ProjectTabData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
