...
homeArticleDataFromJson(HomeArticleDataList data, Map<String, dynamic> json) {
...
Map<String, dynamic> homeArticleDataToJson(HomeArticleDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
homeArticleDataDataFromJson(HomeArticleData data, Map<String, dynamic> json) {
...
Map<String, dynamic> homeArticleDataDataToJson(HomeArticleData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
